...
class ComposeSmokeTest {
    ...
    fun settingsShowsUpdateCenterAndManualCheckButton() {
        ...
        settingsScroll.performScrollToNode(hasText("选择手机铃声"))
        composeRule.onNodeWithText("选择手机铃声").assertIsDisplayed()
        composeRule.onNodeWithText("导入本地音效").assertIsDisplayed()
