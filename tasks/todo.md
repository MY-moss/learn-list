...
- [x] 由应用持有人创建并离线保存 Release keystore，配置 GitHub Actions Secrets；`v0.2.3` 签名 APK 已上传并完成远端摘要/签名核验，仍待真机覆盖安装。
...
- [x] 发布稳定版 `v0.2.3`：已生成签名 APK 与 `.sha256` 并上传 GitHub Release；覆盖安装仍待真机执行。
