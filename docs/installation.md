...
推荐下载已签名的稳定版：[v0.3.2 GitHub Release](https://github.com/MY-moss/learn-list/releases/tag/v0.3.2)，直接获取 [APK](https://github.com/MY-moss/learn-list/releases/download/v0.3.2/learn-list-v0.3.2.apk)；旁边的 `.sha256` 文件可用于校验完整性。
