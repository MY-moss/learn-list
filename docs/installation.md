...
推荐下载已签名的稳定版：[v0.2.1 GitHub Release](https://github.com/MY-moss/learn-list/releases/tag/v0.2.1)，直接获取 [APK](https://github.com/MY-moss/learn-list/releases/download/v0.2.1/learn-list-v0.2.1.apk)；旁边的 `.sha256` 文件可用于校验完整性。
